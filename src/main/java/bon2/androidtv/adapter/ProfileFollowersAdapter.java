...
public class ProfileFollowersAdapter extends TVRecyclerViewAdapter<TVRecyclerViewAdapter.ViewHolder> {
    private static final String TAG = "PeopleAdapter";

    Context mContext;

    public ProfileFollowersAdapter(Context context) {
        mContext = context;
    ...
    public TVRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_one_profile_followers, parent, false);
