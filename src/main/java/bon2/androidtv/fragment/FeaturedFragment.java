...
import bon2.androidtv.adapter.Featured_events_RecyclerViewAdapter;
...
public class FeaturedFragment extends Fragment {
    ...
    public TVRecyclerView event_list, people_list;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View layout = inflater.inflate(R.layout.fragment_featured, container, false);

        event_list = layout.findViewById(R.id.featured_event_list);
        LinearLayout.LayoutParams params1 = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        params1.gravity = Gravity.LEFT;
        event_list.setLayoutParams(params1);
        ...
        event_list.addItemDecoration(new DefaultItemDecoration(20,5, 0, 10));
        event_list.setAdapter(new Featured_events_RecyclerViewAdapter(this.getContext()));

        people_list = layout.findViewById(R.id.featured_people_list);
        ...
        people_list.setLayoutManager(manager1);
        ...
        vscroll = layout.findViewById(R.id.featured_vscroll);
        hsv = layout.findViewById(R.id.list_scrollview);
        rl = layout.findViewById(R.id.featured_video_list);
        ...
        for(int i=0 ; i<COUNT ; i++) {
            ...
            title1.setText("Featured text" + i);
