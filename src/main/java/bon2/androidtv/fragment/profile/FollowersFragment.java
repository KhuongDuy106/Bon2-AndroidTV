...
import bon2.androidtv.adapter.ProfileFollowersAdapter;
...
public class FollowersFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View layout = inflater.inflate(R.layout.frag_profile_followers, container, false);
        ...
        rv.setAdapter(new ProfileFollowersAdapter(this.getContext()));
